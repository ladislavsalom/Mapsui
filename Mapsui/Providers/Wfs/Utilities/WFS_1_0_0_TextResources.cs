...
namespace Mapsui.Providers.Wfs.Utilities
{
    public class WFS_1_0_0_TextResources : WFS_1_0_0_XPathTextResources, IWFS_TextResources
    {
        ...
        public string GetFeatureGETRequest(WfsFeatureTypeInfo featureTypeInfo, string labelProperty, BoundingBox boundingBox, IFilter filter)
        {
            ...
            var tl = SphericalMercator.ToLonLat(boundingBox.TopLeft.X, boundingBox.TopLeft.Y);
            var br = SphericalMercator.ToLonLat(boundingBox.BottomRight.X, boundingBox.BottomRight.Y);
            ...
            filterBuilder.Append(XmlConvert.ToString(tl.X) + ",");
            filterBuilder.Append(XmlConvert.ToString(br.Y) + "%20");
            filterBuilder.Append(XmlConvert.ToString(br.X) + ",");
            filterBuilder.Append(XmlConvert.ToString(tl.Y));
